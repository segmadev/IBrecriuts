...
//    Route::post('/read-all-notification', [NotificationController::class, 'readAllNotification'])->name('read-all-notification');
    ...
    Route::post('employers/{company}/change-is-verify', [CompanyController::class, 'changeIsVerify'])->name('change.company.is_verify');
    ...
    Route::get('jobs/{job}/applications', [JobApplicationController::class, 'index'])->name('admin.job.applications');
...
//    Route::post('job-applications/get-job-stage/{Id}', [JobApplicationController::class, 'getJobStage'])->name('get.job.stage');
    ...
    // Route::get('jobs/{job}/applications', [JobController::class, 'edit'])->name('job.edit');
